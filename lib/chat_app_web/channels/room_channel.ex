defmodule ChatAppWeb.RoomChannel do
  ...
  # do not send broadcasted `"message:add"` events if this socket's user
  # is ignoring the user who sent.
def handle_out("message:add", msg, socket) do
